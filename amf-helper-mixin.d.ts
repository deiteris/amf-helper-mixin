...
interface Namespace {
   ...
   * AMF namespace
   * @type {Object}
   * @property {string} key - AMF's key
   * @property {Object} vocabularies - AMF's vocabularies
   * @property {string} vocabularies.key - AMF's vocabularies key
   * @property {Object} vocabularies.document - AMF's vocabularies document namespace
   * @property {Object} vocabularies.core - AMF's vocabularies core namespace
   * @property {Object} vocabularies.security - AMF's vocabularies security namespace
   * @property {Object} vocabularies.apiContract - AMF's vocabularies apiContract namespace
   * @property {Object} vocabularies.shapes - AMF's vocabularies shapes namespace
   * @property {Object} vocabularies.data - AMF's vocabularies data namespace
   * @property {Object} vocabularies.docSourceMaps - AMF's vocabularies docSourceMaps namespace
   */
  aml: Object;
  /**
   * W3 namespace
   *
   * @property {string} key - W3 namespace's key
   * @property {Object} rdfSyntax - W3's RDF Syntax namespace
   * @property {Object} rdfSchema - W3's RDF Schema namespace
   * @property {Object} hydra - W3's Hydra namespace
   * @property {Object} xmlSchema - W3's xml namespace
   * @property {Object} shacl - W3's shacl namespace
   */
  w3: Object;
  /**
...
interface AmfHelperMixin {
   ...
   */
  _computeUri(endpoint: object|null, opts: object): any;
